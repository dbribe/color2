"""
Django settings for color2 project.
...
AUTH_USER_MODEL = "color2app.User"
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "color2app.context_processor.default",
            ],
        },
    },
]
...
PUBLIC_STATE_PATHS = [
    (
        os.path.join(PROJECT_ROOT, "color2app/templates/PublicState.jstemplate"),
        os.path.join(PROJECT_ROOT, "color2app/static/js/PublicState.js")
    ),
]
...
WSGI_APPLICATION = 'color2.wsgi.application'
